...
def get_jwt(dartmouth_api_key: str = None, jwt_url: str = None) -> str | None:
    ...
    :param dartmouth_api_key: A Dartmouth API key. If set to None, will try to use environment variable {ENV_NAMES['dartmouth_api_key']}. Defaults to None
    :type dartmouth_api_key: str, optional
    :param jwt_url: he URL of the endpoint returning the JWT. If set to None, defaults to {JWT_URL}. Defaults to None
    :type jwt_url: str, optional
    :raises ValueError: No API key is provided and no environment variable {ENV_NAMES['dartmouth_api_key']} can be found.
